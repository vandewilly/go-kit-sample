...
import (
	...
	"github.com/vandewilly/go-kit-sample/service"
)
...
func MakeTotalRetailPriceHttpHandler(logger log.Logger, svc PricingService) *httptransport.Server {
	...
	retailEndpoint = service.LogTotalRetailPriceEndpoint(log.With(logger, "service", "PricingService"))(retailEndpoint)
...
func MakeTotalWholesalePriceHttpHandler(logger log.Logger, svc PricingService) *httptransport.Server {
	...
	wholesaleEndpoint = service.LogTotalWholesalePriceEndpoint(log.With(logger, "service", "PricingService"))(wholesaleEndpoint)
